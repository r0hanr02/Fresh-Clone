...
export const every_restaurents = [
...
export const restaurantsMumbai = [
  {
...
export const testimonials = [
  {
    name: "Rahul Sharma",
    review:
      "Swiggy has made my life easier with fast delivery and great offers!",
  },
  {
    name: "Ananya Kapoor",
    review: "I love the variety of food choices available. Highly recommend!",
  },
  {
    name: "Vikram Verma",
    review:
      "A seamless experience with Swiggy Instamart for quick grocery needs.",
  },
];
...
export const items = [
  ...
  {
    name: "Dineout",
    img: "https://www.medianews4u.com/wp-content/uploads/2019/08/Dineout.jpg",
  },
  {
    name: "Instamart",
    img: "https://mma.prnewswire.com/media/1653992/instamart2_Logo.jpg",
  }
];
